                            ...
                            <div class="auto-style1">
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body" id="chartFatturazioneMensile">
                                        ...
                                        <!-- Text input-->
                                        <div class="form-group">
                                            <label class="col-md-4 control-label" for="txt_copete">Subtitulo de actividad</label>
                                        ...
                                        <!-- Text tarea-->
                                        <div class="form-group">
                                            <label class="col-md-4 control-label" for="txt_cuerpo">Cuerpo de actividad</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txt_fecha_pub" name="fp_text" type="text" placeholder="" class="form-control input-md" runat="server" TextMode="Date" Enabled="false" CssClass="form-control"></asp:TextBox>
                                        ...
                                        <!-- File Button -->
                                        <div class="form-group">
                                            <label class="col-md-4 control-label" for="btnUpload">Subir imagen</label>
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-8">
                                                <asp:Button runat="server" ID="cargar_not_boton" OnClick="btnUploadClick" Text="Modificar actividad" class="btn btn-success" />
                                                  <a href="home.aspx" class="block"><button type="button" class="btn btn-default" data-dismiss="modal" ">Volver atrás</button></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
